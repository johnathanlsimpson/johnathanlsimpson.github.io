<!-- Web Development -->
<div class="section section--horizontal section--development" data-anchor="development">
	...
	<?php
		...
		include('partial-michael.php');
	?>
	
	<!-- Navigation -->
	<div class="nav--slides">
		<a class="nav__bullet a--attention" href="#development/0"></a>
		<a class="nav__bullet a--attention" href="#development/1"></a>
